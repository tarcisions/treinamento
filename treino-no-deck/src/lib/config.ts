...
export const config = {
  eventDate: env('NEXT_PUBLIC_EVENT_DATE', '2026-08-23T06:30:00-03:00'),
  checkoutUrl: env('NEXT_PUBLIC_CHECKOUT_URL', 'https://pay.hotmart.com/EXEMPLO123'),
  totalVagas: Number(env('NEXT_PUBLIC_TOTAL_VAGAS', '50')),
  vagasPreenchidas: Number(env('NEXT_PUBLIC_VAGAS_PREENCHIDAS', '38')),
